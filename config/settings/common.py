...
MIDDLEWARE_CLASSES = (
    ...
    'casereport.middleware.CurrentUserMiddleware',
...
WEEKLY_SUMMARY_EMAIL = "Sarcoma Central <info@mg.rapidscience.org>"
...
DOMAIN = env('DOMAIN', default='sarcoma.rapidscience.org')
